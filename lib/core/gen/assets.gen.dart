...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/red_marker.png
  AssetGenImage get redMarker =>
      const AssetGenImage('assets/images/red_marker.png');

  /// List of all assets
  List<AssetGenImage> get values => [redMarker];
}
...
class $AssetsJsonGen {
  ...
  /// File path: assets/json/route.json
  String get route => 'assets/json/route.json';
